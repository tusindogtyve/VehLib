...
interface dialog_box create  &
   dialog_box_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact  &
   location = 547.0, 28.0  &
   height = 346.0  &
   width = 333.0  &
   units = pixel  &
...
interface push_button create  &
   push_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.button_1  &
...
!
interface push_button create  &
   push_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.button_2  &
...
!
interface push_button create  &
   push_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.button_3  &
   location = 97.0, 317.0  &
   height = 25.0  &
   width = 76.0  &
   units = pixel  &
...
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_1  &
   location = 5.0, 4.0  &
   height = 25.0  &
   width = 200.0  &
   units = pixel  &
...
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.ModelName  &
   location = 207.0, 4.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_2  &
   location = 21.0, 60.0  &
   height = 25.0  &
   width = 180.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_3  &
   location = 21.0, 87.0  &
   height = 25.0  &
   width = 174.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.InnerBeam  &
   location = 206.0, 60.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.OuterBeam  &
   location = 206.0, 87.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
interface separator create  &
   separator_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.sep_1  &
   location = 4.0, 31.0  &
   width = 325.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_4  &
   location = 4.0, 33.0  &
   height = 25.0  &
   width = 226.0  &
   units = pixel  &
...
!
interface separator create  &
   separator_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.sep_2  &
   location = 4.0, 114.0  &
   width = 325.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_5  &
   location = 4.0, 116.0  &
   height = 25.0  &
   width = 325.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_6  &
   location = 21.0, 170.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_7  &
   location = 4.0, 143.0  &
   height = 160.0  &
   width = 15.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_9  &
   location = 21.0, 197.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_10  &
   location = 21.0, 251.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_11  &
   location = 21.0, 278.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_12  &
   location = 4.0, 60.0  &
   height = 52.0  &
   width = 15.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Cont_TopBot  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Cont_Sides  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Cont_Thickness  &
...
!
interface field create  &
   field_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Cont_Length  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_14  &
   location = 21.0, 224.0  &
   height = 25.0  &
   width = 244.0  &
   units = pixel  &
...
interface toggle_button create  &
   toggle_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Toggle_Thickness  &
...
!
interface toggle_button create  &
   toggle_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Toggle_Length  &
...
!
interface label create  &
   label_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.label_15  &
   location = 21.0, 143.0  &
   height = 25.0  &
   width = 244.0  &
   units = pixel  &
...
!
interface toggle_button create  &
   toggle_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Toggle_TopBot  &
...
!
interface toggle_button create  &
   toggle_button_name = .SDlib_plugin.dboxes.dbox_flexbeam_contact.Toggle_Sides  &
