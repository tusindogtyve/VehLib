...
interface dialog_box create  &
   dialog_box_name = .SauerDanfoss.dboxes.dbox_BHPlate1  &
   location = 911.0, 75.0  &
   height = 526.0  &
   width = 350.0  &
   units = pixel  &
   ...
   execution_commands = "! Get the new name of the sub model",  &
                        ...
                        "  file command read file=\"Level3/Backhoe/BHPlate1\"",  &
                        "  model copy &",  &
                        "     model_name = BHPlate1 &",  &
...
interface push_button create  &
   push_button_name = .SauerDanfoss.dboxes.dbox_BHPlate1.button_1  &
...
!
interface push_button create  &
   push_button_name = .SauerDanfoss.dboxes.dbox_BHPlate1.button_2  &
...
!
interface push_button create  &
   push_button_name = .SauerDanfoss.dboxes.dbox_BHPlate1.button_3  &
...
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_1  &
   location = 4.0, 141.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_2  &
   location = 4.0, 249.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_3  &
   location = 4.0, 195.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_4  &
   location = 4.0, 222.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_4_2  &
   location = 4.0, 303.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_4_3  &
   location = 4.0, 168.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_4_2_2  &
   location = 4.0, 276.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_1  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_2  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_3  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_4  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_5  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_6  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_7  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_5  &
   location = 4.0, 332.0  &
   height = 25.0  &
   width = 342.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_6  &
   location = 4.0, 359.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_7  &
   location = 4.0, 386.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_8  &
   location = 4.0, 440.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_9  &
   location = 4.0, 467.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_8  &
...
interface separator create  &
   separator_name = .SauerDanfoss.dboxes.dbox_BHPlate1.sep_2  &
   location = 4.0, 330.0  &
   width = 342.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_9  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_10  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_11  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_10  &
   location = 4.0, 4.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_12  &
   location = 226.0, 4.0  &
   height = 25.0  &
   width = 120.0  &
   units = pixel  &
...
!
interface separator create  &
   separator_name = .SauerDanfoss.dboxes.dbox_BHPlate1.sep_3  &
   location = 4.0, 139.0  &
   width = 342.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_14  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_12  &
   location = 4.0, 413.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_11  &
   location = 4.0, 31.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_13  &
   location = 4.0, 58.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_14  &
   location = 4.0, 85.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_13  &
   location = 226.0, 31.0  &
   height = 25.0  &
   width = 120.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_15  &
   location = 226.0, 58.0  &
   height = 25.0  &
   width = 120.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_16  &
   location = 226.0, 85.0  &
   height = 25.0  &
   width = 120.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .SauerDanfoss.dboxes.dbox_BHPlate1.label_15  &
   location = 4.0, 112.0  &
   height = 25.0  &
   width = 220.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .SauerDanfoss.dboxes.dbox_BHPlate1.field_17  &
