...
interface dialog_box create  &
   dialog_box_name = .gui.contact_at_beam_elements  &
   location = 761.0, 43.0  &
   height = 393.0  &
   width = 333.0  &
   units = pixel  &
...
interface push_button create  &
   push_button_name = .gui.contact_at_beam_elements.button_1  &
...
!
interface push_button create  &
   push_button_name = .gui.contact_at_beam_elements.button_2  &
...
!
interface push_button create  &
   push_button_name = .gui.contact_at_beam_elements.button_3  &
   location = 97.0, 364.0  &
   height = 25.0  &
   width = 76.0  &
   units = pixel  &
...
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_1  &
   location = 5.0, 4.0  &
   height = 25.0  &
   width = 200.0  &
   units = pixel  &
...
interface field create  &
   field_name = .gui.contact_at_beam_elements.ModelName  &
   location = 207.0, 4.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_2  &
   location = 21.0, 60.0  &
   height = 25.0  &
   width = 180.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_3  &
   location = 21.0, 87.0  &
   height = 25.0  &
   width = 174.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.InnerBeam  &
   location = 206.0, 60.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.OuterBeam  &
   location = 206.0, 87.0  &
   height = 25.0  &
   width = 122.0  &
   units = pixel  &
...
interface separator create  &
   separator_name = .gui.contact_at_beam_elements.sep_1  &
   location = 4.0, 31.0  &
   width = 325.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_4  &
   location = 4.0, 33.0  &
   height = 25.0  &
   width = 226.0  &
   units = pixel  &
...
!
interface separator create  &
   separator_name = .gui.contact_at_beam_elements.sep_2  &
   location = 4.0, 114.0  &
   width = 325.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_5  &
   location = 4.0, 116.0  &
   height = 25.0  &
   width = 325.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_6  &
   location = 21.0, 225.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_7  &
   location = 4.0, 143.0  &
   height = 160.0  &
   width = 15.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_9  &
   location = 21.0, 252.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_10  &
   location = 21.0, 279.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_11  &
   location = 21.0, 306.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_12  &
   location = 4.0, 60.0  &
   height = 52.0  &
   width = 15.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.SpringStiffness  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.Damping  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.TorsionalSpringStiffness  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.TorsionalDamping  &
...
interface toggle_button create  &
   toggle_button_name = .gui.contact_at_beam_elements.toggle_1  &
   location = 21.0, 144.0  &
   height = 25.0  &
   width = 308.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_8  &
   location = 21.0, 171.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_13  &
   location = 21.0, 198.0  &
   height = 25.0  &
   width = 188.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.field_1  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.field_2  &
...
!
interface separator create  &
   separator_name = .gui.contact_at_beam_elements.sep_2_2  &
   location = 4.0, 333.0  &
   width = 325.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .gui.contact_at_beam_elements.label_14  &
   location = 4.0, 335.0  &
   height = 25.0  &
   width = 248.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.contact_at_beam_elements.field_3  &
