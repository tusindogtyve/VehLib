...
interface dialog_box create  &
   dialog_box_name = .gui.dbox_MarkerLoc  &
...
interface push_button create  &
   push_button_name = .gui.dbox_MarkerLoc.button_1  &
...
!
interface push_button create  &
   push_button_name = .gui.dbox_MarkerLoc.button_2  &
   location = 41.0, 200.0  &
   height = 25.0  &
   width = 76.0  &
   units = pixel  &
...
interface field create  &
   field_name = .gui.dbox_MarkerLoc.field_1  &
   location = 155.0, 31.0  &
   height = 25.0  &
   width = 130.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.dbox_MarkerLoc.field_2  &
   location = 155.0, 58.0  &
   height = 25.0  &
   width = 130.0  &
   units = pixel  &
...
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_1  &
   location = 4.0, 31.0  &
   height = 25.0  &
   width = 149.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_2  &
   location = 4.0, 58.0  &
   height = 25.0  &
   width = 149.0  &
   units = pixel  &
...
!
interface field create  &
   field_name = .gui.dbox_MarkerLoc.field_4  &
...
!
interface field create  &
   field_name = .gui.dbox_MarkerLoc.field_5  &
...
!
interface field create  &
   field_name = .gui.dbox_MarkerLoc.field_6  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_3  &
   location = 4.0, 114.0  &
   height = 25.0  &
   width = 149.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_4  &
   location = 4.0, 141.0  &
   height = 25.0  &
   width = 149.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_5  &
   location = 4.0, 168.0  &
   height = 25.0  &
   width = 149.0  &
   units = pixel  &
...
interface separator create  &
   separator_name = .gui.dbox_MarkerLoc.sep_2  &
   location = 4.0, 85.0  &
   width = 281.0  &
   units = pixel  &
   horiz_resizing = attach_left  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_9  &
   location = 4.0, 87.0  &
   height = 25.0  &
   width = 281.0  &
   units = pixel  &
...
!
interface label create  &
   label_name = .gui.dbox_MarkerLoc.label_10  &
   location = 4.0, 4.0  &
   height = 25.0  &
   width = 281.0  &
   units = pixel  &
...
!
interface push_button create  &
   push_button_name = .gui.dbox_MarkerLoc.button_3  &
